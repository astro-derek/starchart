...
chart.py   --dpi 300 -r6  --mag 11 --width 33.1 --height 46.8 --factor 1 --scaleR 2 --ngc_max 8  --out r6_high.png --bayer_font 32 --hip_font 24 --ngc_font 24 --con_font 90 --labelLimit 6 --figure_line_width 3 --con_line_width 3 --ecliptic_line_width 4 --tick_width 2
